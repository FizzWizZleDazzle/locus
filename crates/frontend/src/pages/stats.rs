...
use locus_common::{DailyActivityResponse, DailyDayStatus, EloHistoryPoint, TopicStatsEntry, UserStatsResponse};
...
#[component]
fn ActivityMatrix(days: Vec<locus_common::DailyActivityDay>) -> impl IntoView {
    use chrono::Datelike;
